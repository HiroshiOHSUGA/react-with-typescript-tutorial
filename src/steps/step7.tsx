...
export const App: React.VFC = () => {
  ...
  const handleOnChange = React.useCallback<Exclude<React.ComponentProps<"input">['onChange'], undefined>>((event) => {
  ...
  return (
    <div>
      <form>
        <input type="text" name="title" value={todoTitle} onChange={handleOnChange} />
